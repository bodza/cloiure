...
public class InlineCacheGuardPosition extends NodeSourcePosition
{
    ...
    {
        return "dispatchedType=" + (dispatchedType == null ? "null" : dispatchedType.getName()) + " target_method=" + concreteMethod.getName() + " target_method_class=" + concreteMethod.getDeclaringClass().getName() + " position=" + super.toString();
    }
}
