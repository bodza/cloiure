...
public class GraphNodeVerifier
{
    ...
    public GraphNodeVerifier(GraphNodeProcessor processor)
    {
        ...
        this.Input = getTypeElement("graalvm.compiler.graph.Node.Input");
        this.OptionalInput = getTypeElement("graalvm.compiler.graph.Node.OptionalInput");
        this.Successor = getTypeElement("graalvm.compiler.graph.Node.Successor");
        this.Node = getTypeElement("graalvm.compiler.graph.Node");
        this.NodeInputList = getTypeElement("graalvm.compiler.graph.NodeInputList");
        this.NodeSuccessorList = getTypeElement("graalvm.compiler.graph.NodeSuccessorList");
