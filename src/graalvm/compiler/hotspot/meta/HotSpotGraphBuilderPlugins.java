...
import graalvm.compiler.hotspot.replacements.CRC32CSubstitutions;
import graalvm.compiler.hotspot.replacements.CRC32Substitutions;
import graalvm.compiler.hotspot.replacements.CallSiteTargetNode;
import graalvm.compiler.hotspot.replacements.CipherBlockChainingSubstitutions;
...
import graalvm.compiler.hotspot.replacements.ReflectionGetCallerClassNode;
import graalvm.compiler.hotspot.replacements.ReflectionSubstitutions;
import graalvm.compiler.hotspot.replacements.SHA2Substitutions;
import graalvm.compiler.hotspot.replacements.SHA5Substitutions;
import graalvm.compiler.hotspot.replacements.SHASubstitutions;
...
import graalvm.compiler.nodes.graphbuilderconf.ForeignCallPlugin;
...
import graalvm.compiler.nodes.graphbuilderconf.NodeIntrinsicPluginFactory;
...
import graalvm.compiler.replacements.MethodHandlePlugin;
import graalvm.compiler.replacements.NodeIntrinsificationProvider;
import graalvm.compiler.replacements.ReplacementsImpl;
import graalvm.compiler.replacements.StandardGraphBuilderPlugins;
