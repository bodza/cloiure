...
import static graalvm.compiler.lir.LIRValueUtil.isIntConstant;
...
import graalvm.compiler.lir.amd64.AMD64ArrayCompareToOp;
import graalvm.compiler.lir.amd64.AMD64ArrayEqualsOp;
import graalvm.compiler.lir.amd64.AMD64Binary;
import graalvm.compiler.lir.amd64.AMD64BinaryConsumer;
import graalvm.compiler.lir.amd64.AMD64ByteSwapOp;
import graalvm.compiler.lir.amd64.AMD64Call;
import graalvm.compiler.lir.amd64.AMD64ControlFlow;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.BranchOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.CondMoveOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.CondSetOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.FloatBranchOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.FloatCondMoveOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.FloatCondSetOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.ReturnOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.StrategySwitchOp;
import graalvm.compiler.lir.amd64.AMD64ControlFlow.TableSwitchOp;
import graalvm.compiler.lir.amd64.AMD64LFenceOp;
import graalvm.compiler.lir.amd64.AMD64Move;
import graalvm.compiler.lir.amd64.AMD64Move.CompareAndSwapOp;
import graalvm.compiler.lir.amd64.AMD64Move.MembarOp;
import graalvm.compiler.lir.amd64.AMD64Move.StackLeaOp;
import graalvm.compiler.lir.amd64.AMD64PauseOp;
import graalvm.compiler.lir.amd64.AMD64StringIndexOfOp;
import graalvm.compiler.lir.amd64.AMD64ZapRegistersOp;
import graalvm.compiler.lir.amd64.AMD64ZapStackOp;
