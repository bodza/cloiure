...
public class PluginGenerator
{
    ...
    protected static void createImports(PrintWriter out, List<GeneratedPlugin> plugins)
    {
        ...
        out.printf("import graalvm.compiler.nodes.graphbuilderconf.GraphBuilderContext;\n");
        out.printf("import graalvm.compiler.nodes.graphbuilderconf.GeneratedInvocationPlugin;\n");
        out.printf("import graalvm.compiler.nodes.graphbuilderconf.InvocationPlugin;\n");
        out.printf("import graalvm.compiler.nodes.graphbuilderconf.InvocationPlugins;\n");
