...
public class InjectedDependencies implements Iterable<Dependency>
{
    ...
    private static final class InjectedStampDependency extends Dependency
    {
        ...
        {
            super("stamp", "graalvm.compiler.core.common.type.Stamp");
        }
    ...
    public enum WellKnownDependency
    {
        ...
        SNIPPET_REFLECTION(new InjectedDependency("snippetReflection", "graalvm.compiler.api.replacements.SnippetReflectionProvider")),
        STAMP_PROVIDER("b.getStampProvider()", "graalvm.compiler.nodes.spi.StampProvider"),
        STRUCTURED_GRAPH("b.getGraph()", "graalvm.compiler.nodes.StructuredGraph");
