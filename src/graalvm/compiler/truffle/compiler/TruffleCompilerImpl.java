...
import static graalvm.compiler.core.CompilationWrapper.ExceptionAction.Diagnose;
import static graalvm.compiler.core.GraalCompilerOptions.CompilationBailoutAction;
import static graalvm.compiler.core.GraalCompilerOptions.CompilationFailureAction;
import static graalvm.compiler.core.common.CompilationRequestIdentifier.asCompilationRequest;
import static graalvm.compiler.phases.OptimisticOptimizations.ALL;
import static graalvm.compiler.phases.OptimisticOptimizations.Optimization.RemoveNeverExecutedCode;
import static graalvm.compiler.phases.OptimisticOptimizations.Optimization.UseExceptionProbability;
import static graalvm.compiler.phases.OptimisticOptimizations.Optimization.UseTypeCheckHints;
import static graalvm.compiler.phases.OptimisticOptimizations.Optimization.UseTypeCheckedInlining;
import static graalvm.compiler.truffle.common.TruffleCompilerOptions.TruffleEnableInfopoints;
import static graalvm.compiler.truffle.common.TruffleCompilerOptions.TruffleExcludeAssertions;
...
public abstract class TruffleCompilerImpl implements TruffleCompiler {
    ...
    static class GraphInfoImpl implements TruffleCompilerListener.GraphInfo {
        ...
        public String[] getNodeTypes(boolean simpleNames) {
            ...
            int i = 0;
            for (graalvm.compiler.graph.Node node : graph.getNodes()) {
