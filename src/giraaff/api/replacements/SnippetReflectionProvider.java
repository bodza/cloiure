...
public interface SnippetReflectionProvider
{
    ...
    ///
    JavaConstant forObject(Object __object);
    ...
    ///
    <T> T asObject(Class<T> __type, JavaConstant __constant);
    ...
    //         {@code null}
    ///
    Object asObject(ResolvedJavaType __type, JavaConstant __constant);
    ...
    ///
    JavaConstant forBoxed(JavaKind __kind, Object __value);
}
