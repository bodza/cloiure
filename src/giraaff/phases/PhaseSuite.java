...
{
    // @field
    private List<BasePhase<? super C>> ___phases;
    // @field
    ...
    {
        ListIterator<BasePhase<? super C>> __it = this.___phases.listIterator();
        while (__it.hasNext())
        {
            __it.next();
        }
    ...
    public boolean removePhase(Class<? extends BasePhase<? super C>> __phaseClass)
    {
        ...
        while (__it.hasNext())
        {
            ...
            else if (__phase instanceof PhaseSuite)
            {
                ...
                {
                    if (__innerSuite.___phases.isEmpty())
                    {
                        __it.remove();
                    }
                    return true;
    ...
    {
        for (BasePhase<? super C> __phase : this.___phases)
        {
