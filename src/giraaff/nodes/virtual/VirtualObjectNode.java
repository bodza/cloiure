...
public abstract class VirtualObjectNode extends ValueNode implements LIRLowerable, IterableNodeType
{
    ...
    // @field
    protected boolean ___hasIdentity;
    // @field
    ...
    protected VirtualObjectNode(NodeClass<? extends VirtualObjectNode> __c, ResolvedJavaType __type, boolean __hasIdentity)
    {
        ...
        this.___hasIdentity = __hasIdentity;
    }
    ...
    ///
    public abstract String entryName(int __i);
    ...
    ///
    public abstract int entryIndexForOffset(ArrayOffsetProvider __arrayOffsetProvider, long __constantOffset, JavaKind __expectedEntryKind);

    ///
    // Returns the {@link JavaKind} of the entry at the given index.
    ///
    public abstract JavaKind entryKind(int __index);
    ...
    {
        return this.___hasIdentity;
    }

    public void setIdentity(boolean __identity)
    {
        this.___hasIdentity = __identity;
    }
    ...
    ///
    public abstract ValueNode getMaterializedRepresentation(FixedNode __fixed, ValueNode[] __entries, LockState __locks);
