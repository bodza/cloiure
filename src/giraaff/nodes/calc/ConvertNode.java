...
public interface ConvertNode extends ValueNodeInterface
{
    ...
    Constant convert(Constant __c, ConstantReflectionProvider __constantReflection);

    Constant reverse(Constant __c, ConstantReflectionProvider __constantReflection);
    ...
    ///
    default boolean preservesOrder(CanonicalCondition __op)
    {
        return isLossless();
    }
    ...
    ///
    default boolean preservesOrder(CanonicalCondition __op, Constant __value, ConstantReflectionProvider __constantReflection)
    {
        return preservesOrder(__op);
    }
}
