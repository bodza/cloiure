...
public final class LoopEndNode extends AbstractEndNode
{
    ...
    public LoopEndNode(LoopBeginNode __begin)
    {
        ...
        this.___endIndex = __idx;
        this.___loopBegin = __begin;
        this.___canSafepoint = __begin.___canEndsSafepoint;
    }
    ...
    {
        updateUsages(this.___loopBegin, __x);
        this.___loopBegin = __x;
    }
    ...
    {
        this.___canSafepoint = false;
    }

    public boolean canSafepoint()
    {
        return this.___canSafepoint;
    }
