...
public interface Replacements
{
    ...
    ///
    StructuredGraph getSnippet(ResolvedJavaMethod __method, Object[] __args);
    ...
    // @return the snippet graph, if any, that is derived from {@code method}
    ///
    StructuredGraph getSnippet(ResolvedJavaMethod __method, ResolvedJavaMethod __recursiveEntry, Object[] __args);
    ...
    ///
    StructuredGraph getSubstitution(ResolvedJavaMethod __method, int __invokeBci);
    ...
    ///
    Bytecode getSubstitutionBytecode(ResolvedJavaMethod __method);
    ...
    ///
    boolean hasSubstitution(ResolvedJavaMethod __method, int __invokeBci);
