...
public interface VirtualizerTool
{
    ...
    ///
    void createVirtualObject(VirtualObjectNode __virtualObject, ValueNode[] __entryState, List<MonitorIdNode> __locks, boolean __ensureVirtualized);
    ...
    // the loaded value).
    ///
    ValueNode getAlias(ValueNode __value);
    ...
    ///
    boolean setVirtualEntry(VirtualObjectNode __virtualObject, int __index, ValueNode __value, JavaKind __accessKind, long __offset);

    default void setVirtualEntry(VirtualObjectNode __virtualObject, int __index, ValueNode __value)
    {
        if (!setVirtualEntry(__virtualObject, __index, __value, null, 0))
        {
            throw new GraalError("unexpected failure when updating virtual entry");
        }
    }

    ValueNode getEntry(VirtualObjectNode __virtualObject, int __index);

    void addLock(VirtualObjectNode __virtualObject, MonitorIdNode __monitorId);

    MonitorIdNode removeLock(VirtualObjectNode __virtualObject);

    void setEnsureVirtualized(VirtualObjectNode __virtualObject, boolean __ensureVirtualized);

    boolean getEnsureVirtualized(VirtualObjectNode __virtualObject);
    ...
    ///
    void replaceWithVirtual(VirtualObjectNode __virtualObject);
    ...
    ///
    void replaceWithValue(ValueNode __replacement);
    ...
    ///
    void replaceFirstInput(Node __oldInput, Node __replacement);
    ...
    ///
    void replaceWith(ValueNode __value);
    ...
    ///
    boolean ensureMaterialized(VirtualObjectNode __virtualObject);
}
