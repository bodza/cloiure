...
public interface Canonicalizable
{
    ...
    ///
    Node canonical(CanonicalizerTool __tool);
    ...
    public interface Unary<T extends Node> extends Canonicalizable
    {
        ...
        ///
        Node canonical(CanonicalizerTool __tool, T __forValue);
        ...
        @Override
        default T canonical(CanonicalizerTool __tool)
        {
            return (T) canonical(__tool, getValue());
        }
    }
    ...
    public interface Binary<T extends Node> extends Canonicalizable
    {
        ...
        // they should never look at the inputs via the this pointer.
        ///
        Node canonical(CanonicalizerTool __tool, T __forX, T __forY);
        ...
        default T canonical(CanonicalizerTool __tool)
        {
            return (T) canonical(__tool, getX(), getY());
        }
    }
