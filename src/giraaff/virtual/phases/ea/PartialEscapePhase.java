...
public final class PartialEscapePhase extends EffectsPhase<PhaseContext>
{
    ...
    protected EffectsPhase.Closure<?> createEffectsClosure(PhaseContext __context, StructuredGraph.ScheduleResult __schedule, ControlFlowGraph __cfg)
    {
        ...
        {
            return new PartialEscapeClosure.FinalClosure(__schedule, __context.getMetaAccess(), __context.getConstantReflection(), __context.getConstantFieldProvider(), __context.getLowerer());
        }
    }
}
