...
public abstract class FrameMap
{
    ...
    ///
    // @field
    private boolean ___accessesCallerFrame;
    ...
    public FrameMap(CodeCacheProvider __codeCache, RegisterConfig __registerConfig)
    {
        ...
        this.___frameSize = -1;
        this.___outgoingSize = __codeCache.getMinimumOutgoingSize();
        this.___objectStackSlots = new ArrayList<>();
    }
    ...
    {
        return this.___accessesCallerFrame;
    }
    ...
    {
        int __unalignedFrameSize = this.___spillSize - returnAddressSize();
        return this.___hasOutgoingStackArguments || __unalignedFrameSize != 0;
    }
    ...
    public void finish()
    {
        this.___frameSize = currentFrameSize();
        if (this.___frameSize > getRegisterConfig().getMaximumFrameSize())
        {
            throw new BailoutException("frame size (%d) exceeded maximum allowed frame size (%d)", this.___frameSize, getRegisterConfig().getMaximumFrameSize());
        }
    }
    ...
    public int offsetForStackSlot(StackSlot __slot)
    {
        ...
        {
            this.___accessesCallerFrame = true;
        }
    ...
    {
        this.___outgoingSize = Math.max(this.___outgoingSize, __argsSize);
        this.___hasOutgoingStackArguments = this.___hasOutgoingStackArguments || __argsSize > 0;
    }
    ...
    {
        return StackSlot.get(__kind, -this.___spillSize + __additionalOffset, true);
    }
    ...
    public StackSlot allocateSpillSlot(ValueKind<?> __kind)
    {
        ...
        this.___spillSize = NumUtil.roundUp(this.___spillSize + __size, __size);
    ...
    public StackSlot allocateStackSlots(int __slots, BitSet __objects)
    {
        ...
        this.___spillSize += spillSlotRangeSize(__slots);
    ...
    {
        this.___objectStackSlots.add(__objectSlot);
    }
}
