...
public abstract class FrameMapBuilder
{
    ...
    ///
    public abstract VirtualStackSlot allocateSpillSlot(ValueKind<?> __kind);
    ...
    ///
    public abstract VirtualStackSlot allocateStackSlots(int __slots, BitSet __objects, List<VirtualStackSlot> __outObjectStackSlots);
    ...
    ///
    public abstract void callsMethod(CallingConvention __cc);

    ///
    // Creates a {@linkplain FrameMap} based on the information collected by this
    // {@linkplain FrameMapBuilder}.
    ///
    public abstract FrameMap buildFrameMap(LIRGenerationResult __result);
}
